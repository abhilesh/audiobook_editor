...
def parse_arguments():
        ...
        parser.add_argument('-ch', '--chapter_heads_only', 
                                                action = 'store_true',
...
def map_srt_to_epub(book_srt,
        ...
        srt_processed = process_srt(book_srt, 
                                        chapter_heads_only=chapter_heads_only)
                ...
                if chapter_heads_only:
                        ...
                        for srt_el in srt_contents_list:
                                if toc_title in srt_el:
                                        ...
                                        chapter_timestamps.append((book_srt_list[best_match_index-1].start, srt_el))
...
if __name__ == "__main__":
        ...
        if input_args.output_file == None:
                ...
                output_file = None
        print(f'book: {book}, output_file: {output_file}')
        map_srt_to_epub(book_srt,epub_book=book,chapter_heads_only=input_args.chapter_heads_only,output_file=output_file)
